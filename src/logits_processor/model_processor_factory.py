...
from src.logits_processor.naive_weighted_logits_processors import\
    BasedOnProbabilityTransferLogits_Naive_Processor
...
class ModelProcessorFactory():
    ...
    def create_processor(processor_type, **kwargs):
        processor_classes = {
            ...
            "based_on_probility_transfer_logits_fp32_naive_processor": BasedOnProbabilityTransferLogits_Naive_Processor,
