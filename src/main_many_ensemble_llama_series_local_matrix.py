...
def main():
    ...
    with open(input_file_path, 'r', encoding='utf-8') as input_file:
        ...
        for index, line in enumerate(tqdm(contents[start_index:])):
            ...
            final_input_prompt = instruction + task_instruction
            main_model_input = main_model_system_template.format(final_input_prompt)
            print(main_model_input)
            ...
            for index in range(0, assist_model_count):
                ...
                assist_model_input_list.append(assist_model_system_template_list[index].format(instruction + demon_instruction))
